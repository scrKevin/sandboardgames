...
MK_Game.prototype.resetGame = function(game)
{
  ...
  for (var i = 0; i < 96; i++)
  {
    ...
    game.gameObj.cards[newDoorCard.id] = newDoorCard;
    doorDeck.attachedCards[newDoorCard.id] = newDoorCard;
  }

  game.gameObj.decks[doorDeck.id] = doorDeck;
  game.gameObj.decks[doorDiscardDeck.id] = doorDiscardDeck;
  ...
  for (var i = 0; i < 74; i++)
  {
    ...
    game.gameObj.cards[newTreasureCard.id] = newTreasureCard;
    treasureDeck.attachedCards[newTreasureCard.id] = newTreasureCard;
  }

  game.gameObj.decks[treasureDeck.id] = treasureDeck;
  game.gameObj.decks[treasureDiscardDeck.id] = treasureDiscardDeck;

  game.gameObj.openboxes['openbox0'] = new Openbox('openbox0', 480+152, 0, 1920 - (480 + (152*2)), 540);
  game.gameObj.openboxes['openbox1'] = new Openbox('openbox1', 480+910, 540, 530, 540);
